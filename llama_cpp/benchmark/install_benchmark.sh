...
if [ ! -f "benchmark_llama_cpp/src/libbenchmark.a" ]; then
	...
	cmake -DCMAKE_BUILD_TYPE=Release -DBENCHMARK_ENABLE_LTO=true -DBENCHMARK_ENABLE_TESTING=false -DCMAKE_CXX_FLAGS="-std=c++11" ../Project-Llama/llama_cpp/benchmark/google_benchmark
	make
